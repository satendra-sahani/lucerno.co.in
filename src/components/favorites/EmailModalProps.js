    ...
    export default function EmailModalProps({ isOpen, setIsEmailModalOpen }) {
        const [formData, setFormData] = useState({
          ...
          const handleSubmit = (e) => {
            ...
            setIsEmailModalOpen(false) // Close modal after form submission
          }
    return (
        <AnimatePresence>
        {isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              onClick={() => setIsEmailModalOpen(false)} // Close modal on backdrop click
            />
            ...
            >
              {/* Close Button */}
              <button
                onClick={() => setIsEmailModalOpen(false)} // Close modal on close button click
