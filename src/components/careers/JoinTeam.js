...
export default function JoinTeam() {
  ...
  return (
    ...
    <section className='container mx-auto mt-5 border-t border-gray-900 p-4'>
     ...
     For over 30 years, Caesarstone has been considered the leading kitchen surfaces brand in Israel and over 50 countries worldwide, using a large selection of the highest quality raw materials in breakthrough designs that set industry trends. Caesarstone displays a strong passion for innovation, technological development, and groundbreaking production processes. We have gained worldwide recognition thanks to our unfailing commitment to safety, high standards of environmental protection, and steadfast interest in the wellbeing of our employees and customers.
     </p>
     <p className='text-lg text-gray-800 mt-3' >
     At Caesarstone, we consistently put people first. Our employees, suppliers, and other partners are always our top priority. We believe that only together, through full cooperation, can we continue to strive for excellence and reach new heights.
     </p>
     <p className='text-lg text-gray-800 mt-3'>
